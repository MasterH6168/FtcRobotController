...
@Autonomous(name="IMURLNoStacks")
public class autoRLNoStacks extends LinearOpMode {
    ...
    final int BODY_GEAR_REDUCTION = 6;
    final double BODY_LENGTH_INCHES = 17;


    final double DEGREES_PER_COUNT = 360.0 / (COUNTS_PER_MOTOR_REV * BODY_GEAR_REDUCTION);
    final double INCHES_PER_DEGREE = 2 * Math.PI * BODY_LENGTH_INCHES / 360.0;
    final double BODY_COUNTS_PER_INCH = 1 / (DEGREES_PER_COUNT * INCHES_PER_DEGREE);
    ...
    public void moveArm(double power, double inches) {
        ...
        if (opModeIsActive()) {
            ...
            int targetPosition = body.getCurrentPosition() + (int) (inches * COUNTS_PER_INCH);


            body.setTargetPosition(targetPosition);
            ...
            while (opModeIsActive() && body.isBusy()) {
